      ...
      Started: {
          ...
          if (0 < o.length)
            if (1200 <= $(window).width()) {
              ...
              o.scrollTop(o.get(0).scrollHeight, -1).niceScroll(t),
                ...
                e &&
                  (o
                    .scrollTop(o.get(0).scrollHeight, -1)
                    .getNiceScroll()
                    .resize(),
                  $(".layout .content .sidebar .sidebar-body")
                    .getNiceScroll()
                    .resize());
        ...
        init: function () {
          this.theme(),
            ...
            $("body").hasClass("rtl") &&
              $(".dropdown-menu.dropdown-menu-right").removeClass(
                "dropdown-menu-right"
              ),
            feather.replace(),
            $(window).width() < 768 &&
        ...
        return (
          $("#pageTour")
            ...
            .on("hidden.bs.modal", function (e) {
              ...
              o.set([
                {
                  'next .sidebar>header>ul>li>[data-navigation-target="friends"]':
                    "You can create a new chat here.",
                },
                {
                  'next .sidebar>header>ul>li>[data-target="#newGroup"]':
                    "You can start a new group to chat with all your friends.",
                },
                {
                  'next [data-navigation-target="favorites"]':
                    "Chats and messages you've added to your favorites appear here.",
                },
                {
                  'next [data-navigation-target="archived"]':
                    "Chats and messages you've archived appear here.",
                },
                { 'next [data-target="#call"]': "Start voice call from here" },
                {
                  'next [data-target="#videoCall"]':
                    "Start a video call from here",
                },
                {
                  "next .navigation>.nav-group>ul>li.brackets+li+li":
                    "Here you can manage your personal information and settings.",
                },
              ]),
                o.run();
            }),
