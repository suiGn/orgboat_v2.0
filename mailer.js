...
<table class="body-wrap" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #eaf0f7; margin: 0;" bgcolor="#eaf0f7">
	...
	if (error) {
	res.render('pages/sec/mail-confirmation', { opt1: "Please try again.", opt2: "Error"})
	
	}
	else {
	res.render('pages/sec/mail-confirmation', { opt1: "Please check your inbox to reset your password", opt2: "Sent Successfully"})
	}
	});
}else{
